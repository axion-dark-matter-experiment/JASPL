...
__kernel void TemplatedConvolve( const __global TYPE* input, __constant TYPE* filter_kernel, __global TYPE* output, const int signal_size, const int kernel_size)
{
